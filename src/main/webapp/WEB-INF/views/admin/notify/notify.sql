...
insert into notify2 (name,title,content) values ('관리자','새봄맞이 특가 이벤트 행사','2023년 새봄을 맞이하여 특별가격 행사를 진행합니다.');
insert into notify2 values (default,'관리자','새봄맞이 특가 이벤트 행사','2023년 새봄을 맞이하여 특별가격 행사를 진행합니다.',default,default,default);
