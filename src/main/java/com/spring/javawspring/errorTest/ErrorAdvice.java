...
//	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public String handle404(NoHandlerFoundException ex, Model model) {
		...
		model.addAttribute("msg", "<p><font color='red'>접속한 페이지 정보가 없습니다. 확인하시고 다시 접속해 주세요.</font></p><p><input type='button' value='이전 페이지로 돌아가기' onclick='history.back();' class='btn btn-secondary'/></p><p>"+ex.getRequestURL()+"</p>");
